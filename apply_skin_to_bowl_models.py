...
def apply_arc_length_corrected_cylindrical_unwrap(vessel_object):
    normalized_arc_length_at_height = compute_arc_length_corrected_height_rings(vessel_object)
...
def apply_skin_to_all_models():
    ...
    if image_file_path is None:
        print("Usage: blender -b --python apply_skin_to_bowl_models.py -- /path/to/image.png")
        return
