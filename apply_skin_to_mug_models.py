...
OUTPUT_DIRECTORY = "output/mug/design/circle/5"
...
def apply_skin_to_single_blend_file(blend_file_path, image_file_path, output_blend_file_path):
    ...
    original_body_material_slot_index = find_material_slot_index_by_name(mesh_data, MUG_BODY_MATERIAL_NAME)
    original_handle_material_slot_index = find_material_slot_index_by_name(mesh_data, MUG_HANDLE_MATERIAL_NAME)
...
def apply_skin_to_all_models():
    ...
    if image_file_path is None:
        print("Usage: blender -b --python apply_skin_to_mug_models.py -- /path/to/image.png")
        return
